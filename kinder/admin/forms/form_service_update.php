	...
	<div class='flexSmall'>
		<div class='blockInput'>
			<label>Количество - serv_quantity<br>
				<input type='text' name='serv_quantity' size='20' placeholder='Например: 100' value='<?= $serv_quantity?>'>
			</label>
		</div>
		<div class='blockInput'>
		...
		<div class='blockInput'>
			<label>Цена - serv_price<br>
				<input type='text' name='serv_price' size='20' placeholder='Например: 10' value='<?= $serv_price?>'>
			</label>
		</div>
		<div class='blockInput'>
			<label>Стоимость - serv_amount<br>
				<input type='text' name='serv_amount' size='20' placeholder='Например: 1000' value='<?= $serv_amount?>'>
			</label>
		</div>
		<div class='blockInput'>
			<label>Дата - serv_date <em>*</em><br>
				<input type='date' name='serv_date' value='<?= $serv_date?>'>
			</label>
		</div>
	</div>
