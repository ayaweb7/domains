...
// Выборка параметров магазинов (город - town, адрес - adress, store_id) на основании предыдущей выборки - $myrow
...
<table class="adm" align="center" width="100%">
	<caption> <!-- Заголовок таблицы -->
		...
		<h1 style='font-size: 2em;' align='center'>№ <em>$myrow[shops_id]</em> - <em style='color: #19910f;'>$myrow[name] $myrow[characteristic]</em> (группа $myrow[gruppa])</br>
			...
			Куплено в магазине <em style='color: #e50000;'>$myrow[shop]</em> по адресу: $myrow5[town], $myrow5[street], $myrow5[house] (№ <em style='color: #19910f;'>$myrow5[store_id]</em>)</br>
