...
$sql_select = array("SELECT count(*) as $select[0], gruppa FROM shops $where_year GROUP BY gruppa ORDER BY $select[0] DESC",
			"SELECT SUM(amount) as $select[1], gruppa FROM shops $where_year GROUP BY gruppa ORDER BY $select[1] DESC");
